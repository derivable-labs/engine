...
class Engine {
    constructor(account, config, chainIdProp = configs_1.DEFAULT_CHAIN) {
        ...
        this.profile = new profile_1.Profile(this.chainId, config);
        this.initServices();
    }
    initServices() {
        ...
        this.RESOURCE = new resource_1.Resource(this.config, this.profile);
        this.PRICE = new price_1.Price(this.config);
        this.CURRENT_POOL = new currentPool_1.CurrentPool(this.config, this.profile);
        this.HISTORY = new history_1.History(Object.assign(Object.assign({}, this.config), { CURRENT_POOL: this.CURRENT_POOL }), this.profile);
        this.SWAP = new swap_1.Swap(Object.assign(Object.assign({}, this.config), { CURRENT_POOL: this.CURRENT_POOL }), this.profile);
        this.CREATE_POOL = new createPool_1.CreatePool(this.config, this.profile);
    }
