...
class PriceDisable {
    ...
    get24hChangeByLog({ baseToken, quoteToken, cToken, currentPrice, baseId, headBlock, range = 40, }) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const blocknumber24hAgo = headBlock - Math.floor(constant_1.MINI_SECOND_PER_DAY / this.config.timePerBlock);
                const eventInterface = new ethers_1.ethers.utils.Interface(Events_json_1.default);
                const { totalBaseReserve, totalQuoteReserve } = yield this.providerToGetLog
                    .getLogs({
                    address: cToken,
    ...
    getNativePrice() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const [wrapToken, usdToken] = res.token0.adr === this.config.addresses.wrapToken
                ? [res.token0, res.token1]
                : [res.token1, res.token0];
            const priceWei = usdToken.reserve.mul((0, helper_1.numberToWei)(1)).div(wrapToken.reserve);
...
exports.PriceDisable = PriceDisable;
//# sourceMappingURL=price.disable.js.map